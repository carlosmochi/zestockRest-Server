...
public class TbEstadoBemPermanenteFacadeREST extends AbstractFacade<TbEstadoBemPermanente> {
    ...
    public TbEstadoBemPermanenteFacadeREST() {
        super(TbEstadoBemPermanente.class);
    }
    ...
    @Override
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<TbEstadoBemPermanente> findAll() {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<TbEstadoBemPermanente> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
