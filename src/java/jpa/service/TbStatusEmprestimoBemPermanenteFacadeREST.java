...
public class TbStatusEmprestimoBemPermanenteFacadeREST extends AbstractFacade<TbStatusEmprestimoBemPermanente> {
    ...
    public TbStatusEmprestimoBemPermanenteFacadeREST() {
        super(TbStatusEmprestimoBemPermanente.class);
    }
    ...
    @Override
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<TbStatusEmprestimoBemPermanente> findAll() {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<TbStatusEmprestimoBemPermanente> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
